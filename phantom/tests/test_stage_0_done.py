...
def test_phantom_version_is_stage_0_dev() -> None:
    ...
    assert phantom.__version__ in {"4.0.0-dev", "4.0.0", "4.0.1", "4.0.2", "4.0.3", "4.0.4", "4.0.5", "4.0.6", "4.0.7", "4.0.8", "4.0.9", "4.0.10", "1.0.0", "1.0.1", "1.0.2", "1.1.0", "1.1.1", "1.1.2", "1.1.3", "1.1.4"}
    # Tuple form is parseable and consistent with the string form.
    assert phantom.VERSION_TUPLE in {(4, 0, 0), (1, 0, 0), (1, 0, 1), (1, 0, 2), (1, 1, 0), (1, 1, 1), (1, 1, 2), (1, 1, 3), (1, 1, 4)}
...
def test_omnicli_legacy_package_still_imports() -> None:
    ...
    assert omnicli.__version__ in {"3.0.12", "4.0.0", "4.0.1", "4.0.2", "4.0.3", "4.0.4", "4.0.5", "4.0.6", "4.0.7", "4.0.8", "4.0.9", "4.0.10", "1.0.0", "1.0.1", "1.0.2", "1.1.0", "1.1.1", "1.1.2", "1.1.3", "1.1.4"}
